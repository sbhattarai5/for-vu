...
##################################################################################################################
# A class which saves a lead's name, age, sex, credit_score, email, and a value generated by heuristics function
# the class variable weights are arbitrary at first, and ofcourse, are learned as we pop items out of the heap
##################################################################################################################
class Lead:
